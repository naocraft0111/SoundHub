<div>
    ...
    <div class="chatlist_body">
            ...
            <div class="chatlist_item" id="chatlist_click" wire:key='{{$conversation->id}}' wire:click="$emit('chatUserSelected', {{$conversation}},{{$this->getChatUserInstance($conversation, $name = 'id') }})">
