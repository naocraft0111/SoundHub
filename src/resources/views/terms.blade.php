@extends('layouts.app')
@section('title', '利用規約 | SoundHub')
@section('content')
<div class="py-4">
    <div class="container">
        <div class="card bg-paper p-4 my-4">
            <div class="card-body">
                <h3 class="text-center fw-bold">利用規約</h3>
                <div class="card-text">
                    <p>
                        この利用規約（以下、「本規約」といいます。）は、SoundHub運営者（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
                    </p>
                </div>
            </div>
            ...
            <div class="card-body mb-4">
                ...
                <div class="card-text">
                    <div class="ms-3">
                        <p>
                            1. ユーザーは、自己の責任において、本サービスに関するパスワードを適切に管理及び保管するものとし、これを第三者に利用させること、または貸与、譲渡、名義変更、売買等をしてはならないものとします。
                        </p>
                        <p>
                            2. パスワードの管理不十分、使用上の過誤、第三者の使用等によって生じた損害に関する責任はユーザーが負うものとし、運営者は一切の責任を負いません。
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body mb-4">
                ...
                <div class="card-text">
                    <div class="ms-3">
                        <p>
                            1. ユーザーは、自ら著作権等の必要な知的財産権を有するか、または必要な権利者の許諾を得た文章、画像や映像等の情報に関してのみ、本サービスを利用し、投稿ないしアップロードすることができるものとします。</p>
                        <p>
